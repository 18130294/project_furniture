...
<body class="animsition">
	...
	Product idDetailProduct = (Product)request.getAttribute("idDetailProduct");
					...
					<div class="p-l-25 p-r-30 p-lr-0-lg">
						<div class="wrap-slick3 flex-sb flex-w">
							...
							<div class="slick3 gallery-lb">
								<div class="item-slick3" data-thumb="images/img/<%=idDetailProduct.getImages() %>">
									<div class="wrap-pic-w pos-relative">
										<img src="images/img/<%=idDetailProduct.getImages() %>" alt="IMG-PRODUCT">

										<a class="flex-c-m size-108 how-pos1 bor0 fs-16 cl10 bg0 hov-btn3 trans-04" href="images/img/<%=idDetailProduct.getImages() %>">
				...
				<div class="col-md-6 col-lg-5 p-b-30">
					<div class="p-r-50 p-t-5 p-lr-0-lg">
						<h4 class="mtext-105 cl2 js-name-detail p-b-14">
							<%=idDetailProduct.getNameProduct() %>
						</h4>
