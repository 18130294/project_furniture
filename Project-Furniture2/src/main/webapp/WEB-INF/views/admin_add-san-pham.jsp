  ...
  <main class="app-content">
    <div class="app-title">
      <ul class="app-breadcrumb breadcrumb">
        <li class="breadcrumb-item"><a href="QuanLySanPhamServlet">Danh sách sản phẩm</a></li>
        ...
        <div class="tile">
          ...
          <div class="tile-body">
  		 ...
  		 <optgroup label="<%=c.getNameCategories()%>" >
              ...
              <!--  
               <div class="form-group col-md-3">
                <label class="control-label">Tên file ảnh</label>
          ...
          <a class="btn btn-cancel" href="CancelEditAndAddPro">Hủy bỏ</a>
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <a class="btn btn-cancel" data-dismiss="modal" href="QuanLySanPhamServlet">Hủy bỏ</a>
          <BR>
        </div>
