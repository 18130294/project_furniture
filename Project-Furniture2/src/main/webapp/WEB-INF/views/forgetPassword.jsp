        ...
        <div class="aa-myaccount-area">         
            <div class="row">
              <div class="col-md-6">
                ...
                <h4><spring:message code="app.forgot.password" /></h4>
                 <form action="sendMail" class="aa-login-form" method="POST">   
                  <p></p>
                  <label for="">Email<span>*</span></label>
                   <input type="text" value="" placeholder="<spring:message code="app.email" />"  name="emailDN" required>
                    ...
                    <button type="submit" class="aa-browse-btn"><spring:message code="app.send.email" /></button>
                  </form>
                </div>
              </div>
