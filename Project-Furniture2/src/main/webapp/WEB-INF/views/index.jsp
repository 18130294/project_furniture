			...
			<div class="top-bar">
				<div class="content-topbar flex-sb-m h-full container">
					...
					<c:if test="${sessionScope.account !=null && sessionScope.account.isAdmin==0}">
						...
						<a href="user_infor" class="flex-c-m trans-04 p-lr-25" >
						...
						<div class="p-l-25 p-r-30 p-lr-0-lg">
							<div class="wrap-slick3 flex-sb flex-w">
								...
								<div class="slick3 gallery-lb">
									<div class="item-slick3" data-thumb="images/img/">
										<div class="wrap-pic-w pos-relative">
											<img src="images/img/product-09.jpg" alt="IMG-PRODUCT">
									...
									<div class="item-slick3" data-thumb="images/img/">
										<div class="wrap-pic-w pos-relative">
											<img src="images/img/" alt="IMG-PRODUCT">
