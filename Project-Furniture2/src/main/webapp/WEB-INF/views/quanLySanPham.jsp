...
%>
  ...
  <div class="app-sidebar__user"><img class="app-sidebar__user-avatar" src="images/img/anhdaidien.jpg" width="50px"
    ...
    <ul class="app-menu">
      ...
      <li><a class="app-menu__item active" href="manage_product"><i
                    ...
                    <div class="tile-body">
                        <div class="row element-button">
                            <div class="col-sm-2">
                              ...
                              <a class="btn btn-add btn-sm" href="formAddProduct" title="Thêm"><i class="fas fa-plus"></i>
                                Tạo mới sản phẩm</a>
                            </div>
                        ...
                        <table class=" table table-hover table-bordered" id="sampleTable">
                            ...
                            <%for(int i =0;i<list.size();i++){ %>
                             <!-- <input type="hidden" name="idSp" value="${pro.idPro}">
                             <input type="hidden" name="namePro" value="${pro.namePro}">
                             <input type="hidden" name="soluongkho" value="${pro.soluongkho}">
                           ...
                           <td width="10"><input type="checkbox" name="check1" value="1"></td>
                                    ...
                                    <td><%=list.get(i).getNameProduct()%></</td>
                                    <td><img src="images/img/<%=list.get(i).getImages() %>" alt="" width="50px;"></td>
                                    <td><%=list.get(i).getSoluongtrongkho()%></td>
                                    <td><span class="badge bg-success"><%=list.get(i).getPrice() %> đồng</span></td>
                                    <td><%=list.get(i).getIdCategory() %></td>
                                    <td><%=list.get(i).getIdSubCategories() %></td>
                                    <td>
                                    
                                    <form action="deleteProduct" method="post">
                                     <input type="hidden" name="id" value="<%=list.get(i).getIdProduct()%>">
                                  <button class="btn btn-primary btn-sm trash" type="submit" title="Xóa"><i class="fas fa-trash-alt"></i>
									</button>
                                        </form>
                                        <a href="showpageedit?id=<%=list.get(i).getIdProduct() %>"class="btn btn-primary btn-sm edit" title="Sửa"><i class="fas fa-edit"></i></a>
                                    </td>
